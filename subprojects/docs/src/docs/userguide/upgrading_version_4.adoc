...
+
Both changes could cause script compilation errors. See the https://github.com/gradle/kotlin-dsl/releases/tag/v1.0-RC13#breaking-changes[Gradle Kotlin DSL release notes] for more information and how to fix builds broken by the changes described above.
...
However the fixed issues are mostly about corner cases in combination with recent features and should have a limited impact.
